...
```mermaid
graph TB
  ComputerScience(<a href="/tech-labs/docs/category/computer-science" target="_blank" rel="noopener noreferrer">Computer Science</a>) --> Probability(<a href="/tech-labs/docs/category/probability/" target="_blank" rel="noopener noreferrer">Probability</a>)
  ...
  Probability --> Combinatorics(<a href="/tech-labs/docs/category/combinatorics/" target="_blank" rel="noopener noreferrer">Combinatorics</a>)
  ...
  Combinatorics --> Statistics(<a href="/tech-labs/docs/category/statistics/" target="_blank" rel="noopener noreferrer">Statistics</a>)

  Statistics --> ComputerHardware(<a href="/tech-labs/docs/computer-hardware/" target="_blank" rel="noopener noreferrer">Computer Hardware</a>)
  ...
  ProcessesAndThreads --> Networking(<a href="/tech-labs/docs/category/networking/" target="_blank" rel="noopener noreferrer">Networking</a>)
  ...
  Networking --> Security(<a href="/tech-labs/docs/category/security/" target="_blank" rel="noopener noreferrer">Security</a>)
  ...
  Security --> AsymptoticNotation(<a href="/tech-labs/docs/category/asymptotic-notation" target="_blank" rel="noopener noreferrer">Asymptotic Notation</a>)
  ...
  AsymptoticNotation --> Recursion(<a href="/tech-labs/docs/category/recursion/" target="_blank" rel="noopener noreferrer">Recursion</a>)

  Recursion --> DataStructures(<a href="/tech-labs/docs/category/data-structures" target="_blank" rel="noopener noreferrer">Data Structures</a>)
  ...
  DataStructures --> Algorithms(<a href="/tech-labs/docs/category/algorithms" target="_blank" rel="noopener noreferrer">Algorithms</a>)
  ...
  Algorithms --> DesignPatterns(<a href="/tech-labs/docs/category/design-patterns" target="_blank" rel="noopener noreferrer">Design Patterns</a>)
  ...
  subgraph NextSteps [Next Steps]
    ...
    Frontend(<a href="/tech-labs/docs/roadmap/frontend" target="_blank" rel="noopener noreferrer">Frontend Development</a>)
    Backend(<a href="/tech-labs/docs/roadmap/backend" target="_blank" rel="noopener noreferrer">Backend Development</a>)
    DataScientist(<a href="/tech-labs/docs/roadmap/data-scientist" target="_blank" rel="noopener noreferrer">AI and Data Scientist</a>)
    Mobile(<a href="/tech-labs/docs/roadmap/mobile" target="_blank" rel="noopener noreferrer">Mobile Development</a>)
    Game(<a href="/tech-labs/docs/roadmap/game" target="_blank" rel="noopener noreferrer">Game Development</a>)
