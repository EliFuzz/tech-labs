...
<Tabs queryString="primary">
  <TabItem value="foundational" label="Foundational">
    **Foundational Patterns** are reusable design principles and best practices for building applications that run on Kubernetes.
    <Tabs queryString="secondary">
      ...
      <TabItem value="declarative" label="Declarative Deployment">
      ...
      <TabItem value="healthProbe" label="Health Probe">
        **Health Probe**
      ...
      <TabItem value="managedLifecycle" label="Managed Lifecycle">
      ...
      <TabItem value="automatedPlacement" label="Automated Placement">
        **Automated Placement**
  ...
  <TabItem value="behavioral" label="Behavioral">
    **Behavioral Patterns** describe how to manage the life-cycle of Pods, which are the basic units of deployment in Kubernetes. Depending on the type of workload, a Pod might run until completion as
    ...
    <Tabs queryString="secondary">
      <TabItem value="batch" label="Batch Job" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="periodic" label="Periodic Job">
      ...
      <TabItem value="daemon" label="Daemon Service">
      ...
      <TabItem value="singleton" label="Singleton Service">
      ...
      <TabItem value="stateless" label="Stateless Service">
      ...
      <TabItem value="stateful" label="Stateful Service">
      ...
      <TabItem value="selfAwareness" label="Self Awareness">
  ...
  <TabItem value="structural" label="Structural">
    ...
    <Tabs queryString="secondary">
      <TabItem value="initContainer" label="Init Container" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="ambassador" label="Ambassador">
  ...
  <TabItem value="configuration" label="Configuration">
    ...
    <Tabs queryString="secondary">
      <TabItem value="envVar" label="EnvVar Configuration" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="configurationResource" label="Configuration Resource">
      ...
      <TabItem value="immutable" label="Immutable Configuration">
      ...
      <TabItem value="template" label="Configuration Template">
  ...
  <TabItem value="security" label="Security">
    ...
    <Tabs queryString="secondary">
      <TabItem value="processContainment" label="Process Containment" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="networkSegmentation" label="Network Segmentation">
      ...
      <TabItem value="secureConfiguration" label="Secure Configuration">
  ...
  <TabItem value="advanced" label="Advanced">
    <Tabs queryString="secondary">
      <TabItem value="controller" label="Controller" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="elasticScale" label="Elastic Scale">
      ...
      <TabItem value="imageBuilder" label="Image Builder">
