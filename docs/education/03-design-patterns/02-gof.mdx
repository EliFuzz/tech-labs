...
<Tabs>
  <TabItem value="creational" label="Creational">
    ...
    <table>
      ...
      <tr>
        ...
        <td>interface for creating objects in a superclass but allows subclasses to alter the type of objects that will be created</td>
      ...
      <tr>
        ...
        <td>interface for creating families of related or dependent objects without specifying their concrete classes</td>
      ...
      <tr>
        ...
        <td>separates the construction of a complex object from its representation, allowing the same construction process to create various representations</td>
      ...
      <tr>
        ...
        <td>specifies the kinds of objects to create using a prototypical instance, and creates new objects by copying this prototype</td>
  ...
  <TabItem value="structural" label="Structural">
    ...
    <table>
      ...
      <tr>
        ...
        <td>composes objects into tree structures to represent part-whole hierarchies</td>
      ...
      <tr>
        ...
        <td>attaches additional responsibilities to an object dynamically, providing a flexible alternative to subclassing</td>
      ...
      <tr>
        ...
        <td>provides a simplified interface to a complex system of classes, libraries, or frameworks</td>
      ...
      <tr>
        ...
        <td>shares common state among multiple objects, effectively reducing memory consumption</td>
  ...
  <TabItem value="behavioral" label="Behavioral">
    ...
    <table>
      ...
      <tr>
        ...
        <td>passes requests along a chain of handlers, allowing multiple objects to handle a request without the sender needing to know which object will ultimately process it</td>
      ...
      <tr>
        ...
        <td>encapsulates a request as an object, thereby allowing for parameterization of clients with queues, requests, and operations</td>
      ...
      <tr>
        ...
        <td>defines a grammatical representation for a language and provides an interpreter to interpret sentences in the language</td>
      ...
      <tr>
        ...
        <td>defines an object that encapsulates how a set of objects interact, promoting loose coupling by keeping objects from referring to each other explicitly</td>
      ...
      <tr>
        ...
        <td>captures and externalizes an object's internal state so that the object can be restored to this state later</td>
      ...
      <tr>
        ...
        <td>allows an object to alter its behavior when its internal state changes, encapsulating state-specific behavior into separate objects</td>
      ...
      <tr>
        ...
        <td>defines a family of algorithms, encapsulates each one, and makes them interchangeable, allowing the algorithm to vary independently from clients that use it</td>
      ...
      <tr>
        ...
        <td>represents an operation to be performed on elements of an object structure, decoupling the algorithm from the object structure</td>
