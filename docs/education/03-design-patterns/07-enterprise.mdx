...
<Tabs>
    ...
    <TabItem value="comparison" label="Comparison Table">
...
<Tabs>
    ...
    <TabItem value="bestPractices" label="Best Practices">
        **Identify and Define the Core Business Domain**
        ...
        - **Define Domain Model:** Define attributes, behaviors, and relationships of identified objects (Customer name, account balance; Account balance, number, and owner)
        ...
        **Command-Query Responsibility Segregation (CQRS)**
        ...
        - **Commands and Queries Usage:** Commands create, update, or delete entities (Queries retrieve data from the domain model)
...
<Tabs>
  ...
  <TabItem value="comparison" label="Comparison">
    ...
    <Tabs>
      <TabItem value="layered" label="Layered Architecture" attributes={{className: "tabs__vertical"}}>
      ...
      <TabItem value="onion" label="Onion Architecture">
