        ...
        <Tabs>
            <TabItem value="data" label="Data Patterns" attributes={{className:"tabs__vertical"}}>
              ...
              ```mermaid
                ...
                subgraph table[Private tables per service]
                    direction TB

                    serviceA(Service A) -->|uses table A| databaseTable[(Database)]
                    serviceB(Service B) -->|uses table B| databaseTable

                    databaseTable -->|contains| tableA(Table A)
                    databaseTable -->|contains| tableB(Table B)
                end

                subgraph schema[Schema per service]
                    direction TB

                    serviceAA(Service A) -->|uses schema A| databaseSchema[(Database)]
                    serviceBB(Service B) -->|uses schema B| databaseSchema

                    databaseSchema -->|contains| schemaA(Schema A)
                    databaseSchema -->|contains| schemaB(Schema B)
                end

                subgraph service[Database server per service]
                    direction TB

                    serviceAAA(Service A) -->|owns| databaseServiceA[(Database)]
                    serviceBBB(Service B) -->|owns| databaseServiceB[(Database)]
                end
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Each service has its own private database</td>
                  </tr>
                  <tr>
                    <td><b>Principles</b></td>
                    <td>
                      <ul>
                        <li>**Database should be private**: inaccessible by other services</li>
                        <li>
                          **Keep data private**
                          <ul>
                            <li>**Private tables per service**: each service owns specific tables (Lowest overhead)</li>
                            <li>**Schema per service**: separate database schema for each service (clear ownership)</li>
                            <li>**Database server per service**: for high-throughput scenarios</li>
                          </ul>
                        </li>
                        <li>**Enforce data privacy**: use separate database users and access controls</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Loose Coupling**: Changes in one service's database don't affect others</li>
                        <li>**Flexibility**: Services can use the best database type for their needs (e.g., ElasticSearch for search, graph database for social graphs)</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Distributed Transactions**: Complex and often unsupported by NoSQL databases (CAP theorem)</li>
                        <li>**Multi-service Queries**: Joining data across databases is challenging</li>
                        <li>**Management Complexity**: Managing multiple databases (SQL and NoSQL) can be complex</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Transactions**: Use the Saga pattern for transactions spanning services</li>
                        <li>
                          **Multi-service queries**
                          <ul>
                            <li>**API Composition**: Application performs joins instead of the database</li>
                            <li>**CQRS**: Maintain materialized views joining data from different services, updated through event subscriptions</li>
                          </ul>
                        </li>
                      </ul>
                    </td>
              ...
              ```mermaid
                ...
                serviceA(Service A) -->|uses| database
                serviceB(Service B) -->|uses| database
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Services share a database</td>
                  </tr>
                  <tr>
                    <td><b>Pros</b></td>
                    <td>
                      <ul>
                        <li>Easy data consistency with familiar transactions</li>
                        <li>Simpler to manage one database</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Slower development due to coordination for schema changes</li>
                        <li>Potential performance issues from services interfering with each other</li>
                        <li>Database may not meet all service needs</li>
                      </ul>
                    </td>
                  </tr>
                </tbody>
              ...
              ```mermaid
                ...
                query1((Query)) --> composer(API Composer)

                composer --->|queryA| providerA(Provider Service A)
                composer --->|queryB| providerA(Provider Service B)
                composer --->|queryC| providerA(Provider Service C)
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Implement queries by invoking the services that own the data and performing an in-memory join</td>
                  </tr>
                  <tr>
                    <td><b>Pros</b></td>
                    <td>
                      <ul>
                        <li>**Simple Data Queries**: Each service owns its data, making queries straightforward within a service</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Inefficient Joins**: Complex queries requiring data from multiple services might involve in-memory joins of large datasets, leading to performance issues</li>
                      </ul>
                    </td>
                  </tr>
                </tbody>
              ...
              ```mermaid
                ...
                writeAPI((Write API)) -->|command| writeDatabase[(Write Database)]
                readAPI((Read API)) --->|query| readDatabase[(Read Database)]
                writeDatabase -->|"trigger update the data (synchronize)"| readDatabase
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Implement queries by maintaining one or more materialized views that can be efficiently queried</td>
                  </tr>
                  <tr>
                    <td><b>Pros</b></td>
                    <td>
                      <ul>
                        <li>**Scalability and Performance**: Supports multiple, denormalized views optimized for specific queries, leading to better performance and scalability</li>
                        <li>**Separation of Concerns**: Clear separation between command and query models simplifies development and maintenance</li>
                        <li>**Event Sourcing**: A natural fit for event-sourced architectures, where events are the source of truth for data updates</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Complexity**: Implementing and managing separate models and data flows can increase overall system complexity</li>
                        <li>**Code Duplication**: Denormalized views might lead to some data redundancy and potential for code duplication</li>
                        <li>**Eventual Consistency**: Due to asynchronous updates, views may not reflect the latest changes immediately (eventual consistency). This requires careful handling for scenarios demanding strict real-time data accuracy</li>
                      </ul>
                    </td>
                  </tr>
                </tbody>
              ...
              Order ->> Order Service: order create
              Order Service ->> Client Service: publish order created event
              Client Service ->> Inventory Service: publish client verified event
              Inventory Service ->> Payment Service: publish inventory updated event
              Payment Service ->> Order Service: publish payment processed event
              Order Service ->> Order: order processed
              ```
              ...
              ```mermaid
                ...
                autonumber
                    ...
                    Order ->> Saga Orchestration: order create

                    Saga Orchestration ->> Order Service: publish order create event
                    Order Service ->> Saga Orchestration: publish order created event

                    Saga Orchestration ->> Client Service: publish client verification event
                    Client Service ->> Saga Orchestration: publish client verified event

                    Saga Orchestration ->> Inventory Service: publish inventory update event
                    Inventory Service ->> Saga Orchestration: publish inventory updated event

                    Saga Orchestration ->> Payment Service: publish payment processing event
                    Payment Service ->> Saga Orchestration: publish payment processed event

                    Saga Orchestration ->> Order: order processed
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Use sagas, which a sequences of local transactions, to maintain data consistency across services</td>
                  </tr>
                  <tr>
                    <td><b>Pros</b></td>
                    <td>
                      <ul>
                        <li>**Data Consistency**: Maintains data consistency across distributed services without complex distributed transactions</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>**Complexity**: Sagas require coordination between multiple services, leading to increased complexity</li>
                        <li>**Atomic Updates**: Requires careful design to ensure updates to the database and message publication happen atomically</li>
                        <li>
                          **Client Outcome**: Different approaches for handling client notification of saga completion have trade-offs
                          <ul>
                            <li>**Long-Polling**: Client polls for updates, leading to potential inefficiency</li>
                            <li>**Event-Driven Notification**: Requires additional infrastructure for event delivery, but offers better responsiveness</li>
                            <li>**Initial Response with Polling**: Balances initial response with potential polling overhead</li>
                          </ul>
                        </li>
                      </ul>
                    </td>
              ...
              ```mermaid
                ...
                Note right of Event Store: append new row<br/>in Event Store database table<br/>for each event

                Order Service ->> Event Store:① Status: ORDER_CREATE
                Order Service ->> Event Store:② Status: ORDER_CREATED


                Event Store ->> Event Broker: publish ORDER_CREATED event
                Client Service -->> Event Broker: subscribed to ORDER_CREATED event
                Client Service ->> Event Store:③ publish CLIENT_VERIFIED event

                Event Store ->> Event Broker: publish CLIENT_VERIFIED event
                Inventory Service -->> Event Broker: subscribed to CLIENT_VERIFIED event
                Inventory Service ->> Event Store:④ publish INVENTORY_UPDATED event

                Event Store ->> Event Broker: publish INVENTORY_UPDATED event
                Payment Service -->> Event Broker: subscribed to INVENTORY_UPDATED event
                Payment Service ->> Event Store:⑤ publish PAYMENT_PROCESSED event

                Event Store ->> Event Broker: publish PAYMENT_PROCESSED event
                Order Service -->> Event Broker: subscribed to PAYMENT_PROCESSED event
                Order Service ->> Order: order processed
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Persist aggregates as a sequence of events</td>
                  </tr>
                  <tr>
                    <td><b>Pros</b></td>
                    <td>
                      <ul>
                        <li>Enables reliable event publishing in event-driven architectures</li>
                        <li>Avoids object-relational impedance mismatch</li>
                        <li>Provides complete audit history of data changes</li>
                        <li>Allows querying past states of entities (time travel)</li>
                        <li>Simplifies migration to microservices due to loosely coupled entities</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Complex querying due to need to reconstruct entity state (Often requires CQRS and eventual consistency)</li>
                      </ul>
                    </td>
                  </tr>
                </tbody>
              ...
              ```mermaid
                ...
                subgraph registration[Registration Domain]
                    direction TB
                ...
                client(Client) --> |① user credentials| userRegistrationService
                client(Client) --> |② verify user credentials| userRegistrationService
                client(Client) --> |③ provide user details| userRegistrationService

                userRegistrationService --> |④ allocate inventory| inventoryService
                userRegistrationService --> |⑤ process payment| paymentService

                userRegistrationService --> |⑥ notify| client
              ```
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><b>Definition</b></td>
                    <td>Organize the business logic of a service as a collection of DDD aggregates that emit domain events when they created or updated. The service publishes these domain events so that they can be consumed by other services</td>
                  </tr>
                </tbody>
              </table>
            </TabItem>
