...
<Tabs queryString="primary">
  <TabItem value="proxy" label="Gateway Proxy">
    <table>
      <thead>
        <tr>
          <th>Aspect</th>
  ...
  <TabItem value="balancer" label="Load Balancer (LB)">
    <Tabs queryString="secondary">
      <TabItem value="algorithms" label="Algorithms" attributes={{className:"tabs__vertical"}}>
          <table>
              <thead>
                  <tr>
                      <th>Algorithm</th>
        ...
        <TabItem value="deployment" label="Deployment Architecture">
          <table>
              <thead>
                <tr>
...
<Tabs queryString="primary">
  <TabItem value="overview" label="Overview">
    <Tabs queryString="secondary">
      ...
      <TabItem value="granularity" label="Granularity">
  ...
  <TabItem value="strategies" label="Strategies">
    <Tabs queryString="secondary">
      <TabItem value="fixedWindow" label="Fixed Window Counter" attributes={{className:"tabs__vertical"}}>
        <table>
          <thead>
            <tr>
              <th>Aspect</th>
      ...
      <TabItem value="leakyBucket" label="Leaky Bucket">
        <table>
          <thead>
            <tr>
              <th>Aspect</th>
      ...
      <TabItem value="slidingWindow" label="Sliding Window">
        <table class="text_vertical">
          <thead>
            <tr>
              <th>Aspect</th>
      ...
      <TabItem value="tokenBucket" label="Token Bucket">
        <table>
          <thead>
            <tr>
              <th>Aspect</th>
  ...
  <TabItem value="geo" label="Geo-Fencing">
    <table class="text_vertical">
      <thead>
        <tr>
          <th>Approach</th>
