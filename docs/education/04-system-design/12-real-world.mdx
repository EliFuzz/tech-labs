...
<Tabs queryString="primary">
    <TabItem value="basic" label="Basic">
        <Tabs queryString="secondary">
            <TabItem value="chat" label="Chat">
                ...
                - **Traffic**:
                  - Activity: $$50M * 40 (messages) = 2B/day$$
                  - Media: $$2B/day * 5% (content with media) = 100M/day$$
                  - RSP: $$\frac{2B/day}{24h * 3600sec} = 24K req/sec$$
                - **Storage**:
                  - Messages: $$2B/day * 100byte (message size) = 200GB/day$$
                  - Media: $$100M/day (messages) * 100KB (media size) = 10TB/day$$, 10 years: $$(10TB/day (media) + 0.2TB/day (messages)) * 10 (years) * 365 (day) = 38PB$$
    ...
    <TabItem value="systems" label="Systems">
        <Tabs queryString="secondary">
            <TabItem value="disney-hotstar" label="Disney Hotstar" attributes={{className:"tabs__vertical"}}>
