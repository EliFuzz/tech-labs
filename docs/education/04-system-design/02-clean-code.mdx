...
<Tabs queryString="primary">
    <TabItem value="clean-code-overview" label="Overview">
      ![](./assets/definition/clean-code-overview.svg)
    </TabItem>
    <TabItem value="clean-code-principles" label="Principles">
    ...
    <TabItem value="clean-code-benefits" label="Benefits">
    ...
    <TabItem value="clean-code-guidelines" label="Guidelines">
       **General**
