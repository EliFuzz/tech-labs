...
<Tabs queryString="primary">
  ...
  <TabItem value="fe_be" label="FE + BE">
    <table>
      <thead>
        <tr>
          <th>Type</th>
...
<Tabs queryString="primary">
  ...
  <TabItem value="jwt" label="JSON Web Token (JWT)">
    <table>
        <thead>
            <tr>
                <th style={{width: '70%'}}>Visualization</th>
  ...
  <TabItem value="ssl" label="SSL Certificates">
    ```mermaid
       sequenceDiagram
       autonumber
