...
<Tabs queryString="primary">
    <TabItem value="overview" label="Overview">
      <Tabs queryString="secondary">
        <TabItem value="lifecycle" label="Lifecycle" attributes={{className:"tabs__vertical"}}>
    ...
    <TabItem value="detailed" label="Detailed">
      <Tabs queryString="secondary">
        <TabItem value="overview" label="High Overview" attributes={{className:"tabs__vertical"}}>
          ```mermaid
              graph LR
    ...
    <TabItem value="distinction" label="Distinction">
      <table>
        <thead>
          <tr>
            <th>Tests Type</th>
    ...
    <TabItem value="test-pyramid" label="Test Pyramid">
