...
<Tabs queryString="primary">
    <TabItem value="paradigm-definition" label="Definition">
        <table>
          <thead>
            <tr>
              <th>Aspect</th>
    ...
    <TabItem value="paradigm-languages" label="Languages">
        <table>
          <thead>
            <tr>
              <th>Language</th>
    ...
    <TabItem value="paradigm-oop" label="OOP">
        <Tabs queryString="secondary">
            <TabItem value="oop-principles" label="Core Principles" attributes={{className:"tabs__vertical"}}>
            ...
            <TabItem value="oop-solid" label="SOLID Principles">
    ...
    <TabItem value="paradigm-functional" label="Functional">
        <Tabs queryString="secondary">
            <TabItem value="functional-overview" label="Overview" attributes={{className:"tabs__vertical"}}>
            ...
            <TabItem value="functional-advantages" label="Advantages">
            ...
            <TabItem value="functional-principles" label="Principles">
