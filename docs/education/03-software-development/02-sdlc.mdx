...
<Tabs queryString="primary">
    <TabItem value="sdlc-overview" label="SDLC">
    ...
    <TabItem value="sdlc-models" label="Models">
        <table>
          <thead>
            <tr>
              <th>SDLC Model</th>
    ...
    <TabItem value="sdlc-methodologies" label="Agile methodologies">
      <Tabs queryString="secondary">
        <TabItem value="methodologies-overview" label="Overview" attributes={{className:"tabs__vertical"}}>
          <table>
            <thead>
              <tr>
                <th>Aspect</th>
        ...
        <TabItem value="methodologies-agile" label="Agile">
            ```mermaid
                graph LR
        ...
        <TabItem value="methodologies-scrum" label="Scrum">
            ```mermaid
                graph LR
        ...
        <TabItem value="methodologies-kanban" label="Kanban">
          ## Visualization
