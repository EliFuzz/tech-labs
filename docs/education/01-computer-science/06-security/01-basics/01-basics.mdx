...
<Tabs>
  <TabItem value="authenAndAuthzDefinition" label="Definition">
    <table>
      ...
      <tr>
        <td>Definition</td>
        <td>The process of verifying the identity of a user</td>
        <td>The process of determining what resources a user can access and what actions they can perform</td>
      </tr>
      <tr>
        <td>Purpose</td>
